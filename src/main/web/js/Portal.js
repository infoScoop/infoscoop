...
IS_Portal.CommandBar = {
	...
	init : function(){
		...
		var portalSquareMenu = $('portal-square-menu');
		var portalSquareMenuLabel = $('portal-square-menu-label');
		var portalSquareMenuBody = $.DIV({id:'portal-square-menu-body', className: 'is-box', style:'display:none;'});
		...
		if(portalSquareMenu) {
			...
			var opt = {
			  ...
			  onSuccess:function(req){
                ...
                var createSquareUI = function(belongSquare, isServiceSquare){
