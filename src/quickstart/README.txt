...
How to Setup
------------
Unzip infoscoop-3.0.0-quickstart.zip(tar.gz) and follow the steps below.
...
$ mysql -uroot iscoop < infoscoop-3.0.0-quickstart/init_infoscoop.sql
...
infoscoop-3.0.0-quickstart/initdb/data/accounts/import.csv
...
$ cd infoscoop-3.0.0-quickstart/initdb
$ addaccount.bat(sh)
