...
How to Setup
------------
Unzip infoscoop-3.3.0-beta-quickstart.zip(tar.gz) and follow the steps below.
...
$ mysql -uroot iscoop < infoscoop-3.3.0-beta-quickstart/init_infoscoop.sql
...
infoscoop-3.3.0-beta-quickstart/initdb/data/accounts/import.csv
...
$ cd infoscoop-3.3.0-beta-quickstart/initdb
$ addaccount.bat(sh)
