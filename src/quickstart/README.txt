...
How to Setup
----------------
Unzip infoscoop-2.2.1-quickstart.zip(tar.gz) and follow the steps below.
...
$ mysql -uroot iscoop < infoscoop-2.2.1-quickstart/init_infoscoop.sql
...
infoscoop-2.2.1-quickstart/initdb/data/accounts/import.csv
...
$ cd infoscoop-2.2.1-quickstart/initdb
$ addaccount.bat(sh)
