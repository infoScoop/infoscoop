...
---------------------------------
To migrate from version 2.1.0 to 2.2.3, follow the steps below.
...
6. Delete backup table
  ...
  After executing the migration tool, the operation creates a backup table that has a suffix named "_bak22".
...
---------------------------------
To migrate from version 2.1.1 to 2.2.3, follow the steps below.
